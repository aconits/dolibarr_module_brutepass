 ...
 */
class brutepassbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "brutepass@brutepass";
    public $boxlabel;
    public $depends = array("brutepass");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/brutepass/class/brutepass.class.php";
